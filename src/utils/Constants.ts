...
function mobileTabletCheck() {
    ...
    (function (a: string) {
        ...
        window.navigator.userAgent ||
            ...
            (window.opera && typeof window.opera === "string"
                ? window.opera
                : ""),
    );
    return check;
...
const getDefaultAudioUrl = () => {
    const isMobileOrTablet = typeof window !== 'undefined' ? mobileTabletCheck() : false;
...
export default {
    ...
    DEFAULT_QUANTIZED: typeof window !== 'undefined' ? mobileTabletCheck() : false,
